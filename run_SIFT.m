...
% COVERAGE th =2.2 min_pt=3 SIFT 21*21 dr2 = 0.95 d=1 0.4380 TP 30 TN 93 FN 70
% FP 7. (acc= 61.5)
% coverage_QF_60 th =2.2 min_pt=3 SIFT 21*21 dr2 = 0.95 d=1  0.1636 TP
% 9 TN 99 FN 91 FP 1.  (acc = 54 )
% coverage_QF_80 th =2.2 min_pt=3 SIFT 21*21 dr2 = 0.95 d=1  0.2667 TP
% 16 TN 96 FN 84 FP 4.  (acc = 56 )
% coverage_g_noise_0.5 th =2.2 min_pt=3 SIFT 21*21 dr2 = 0.95 d=1  0.4818 TP
% 33 TN 96 FN 67 FP 4.  (acc = 64.5 )
% coverage_g_noise_1 th =2.2 min_pt=3 SIFT 21*21 dr2 = 0.95 d=1  0.3906 TP
% 25 TN 97 FN 75 FP 3.  (acc = 61 )
...
% dr=uigetdir();
% 
% list=dir([dr, '/*.png']);        %here jpg is file extension of the images
...
%     imagePath = [dr, '/', list(i).name];
    ...
    % process an image
    i
    countTrasfGeom = process_image(i, metric, th, min_pts, 0);
